...
neg_pos_ratio = 1
selected_cell_type = [] 
dataset_store_path = './bio_graph_datasets/SNARE'

rna_anndata = sc.read_h5ad("./bio_datasets/SNARE-seq/Chen-2019-RNA.h5ad")
print('rna_anndata:',rna_anndata) #9190 cells, 28930 genes
atac_anndata = sc.read_h5ad("./bio_datasets/SNARE-seq/Chen-2019-ATAC.h5ad")
print('atac_anndata:',atac_anndata) #9190 cells, 241757 peaks
