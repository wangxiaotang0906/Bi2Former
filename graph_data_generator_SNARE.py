...
select_cell_type = False #选择部分细胞
if_easy_neg = 1
neg_easy_ratio = 1

selected_cell_type = [""] #["R6 Ex-L5-PT","R12 Misc","R14 In-Hap1"]
dataset_store_path = './bio_graph_datasets/SNARE_full'

rna_anndata = sc.read_h5ad("./bio_datasets/SNARE-seq/Chen-2019-RNA.h5ad")
print('rna_anndata:',rna_anndata) #9190个细胞,28930个基因
atac_anndata = sc.read_h5ad("./bio_datasets/SNARE-seq/Chen-2019-ATAC.h5ad")
print('atac_anndata:',atac_anndata) #9190个细胞,241757个peak
