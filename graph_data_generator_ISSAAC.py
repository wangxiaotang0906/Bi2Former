...
if_easy_neg = 1
neg_easy_ratio = 1
# selected_cell_type = ["R16 In-Sst"] #"R14 In-Hap1","R15 In-Pvalb","R13 In-Drd2",,"R17 In-Tac1","R18 In-Vip/Lamp5"]
selected_cell_type = ["R0 Ex-L2/3 IT","R17 In-Tac1","R19 Astro","R2 Ex-L4 IT","R11 Ex-PIR Ndst4","R15 In-Pvalb","R18 In-Vip/Lamp5","R14 In-Hap1","R4 Ex-L5 NP","R1 Ex-L2/3 IT Act","R5 Ex-L5 NP Cxcl14"] #["R6 Ex-L5-PT","R12 Misc","R14 In-Hap1"]
dataset_store_path = 'bio_graph_datasets/ISSAAC_group_test'

rna_anndata = sc.read_h5ad("./bio_datasets/ISSAAC-seq/ISSAAC_scRNA_format.h5ad")
print('rna_anndata:',rna_anndata) #10361个细胞,20771个基因
atac_anndata = sc.read_h5ad("./bio_datasets/ISSAAC-seq/ISSAAC_scATAC_format.h5ad")
print('atac_anndata:',atac_anndata) #10361个细胞,169180个peak
