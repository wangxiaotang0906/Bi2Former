...
dataset_store_path = './bio_graph_datasets/SHARE_full'

rna_anndata = sc.read_h5ad("./bio_datasets/SHARE-seq/Ma-2020-RNA.h5ad")
print('rna_anndata:',rna_anndata) #32231个细胞,21478个基因
atac_anndata = sc.read_h5ad("./bio_datasets/SHARE-seq/Ma-2020-ATAC.h5ad")
print('atac_anndata:',atac_anndata) #32231个细胞,340341个peak
